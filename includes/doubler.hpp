...
Diagram doubleEdge(const Diagram& base, unsigned target, unsigned respective); //returns a new diagram obtained by doubling rotating the target mirror so it has twice the angle with the respective mirror
